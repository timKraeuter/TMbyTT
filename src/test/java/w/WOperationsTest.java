...
public class WOperationsTest {
	...
	public void testMultiply() {
		...
		for (int xi = 0; xi < 10; xi++) {
			for (int yi = 0; yi < 10; yi++) {
				...
				TuringMaschinen
						.createSeq(TuringMaschinen.copy(f1, f11),
								TuringMaschinen.createSeq(TuringMaschinen.copy(ChangeableBand.create("0"), f1),
										TuringMaschinen.createSeq(TuringMaschinen.copy(f2, f21),
												TuringMaschinen.createWhileNotEqual(f21,
														TuringMaschinen.createSeq(
																TuringMaschinen.createAdd(f1, f11, f1),
																TuringMaschinen.createSub(f21,
																		ChangeableBand.create("1"), f21))))))
						.simuliere();
	...
	public void testGreaterThanOrEqual() {
		ChangeableBand t1 = ChangeableBand.create("0");
		ChangeableBand t2 = ChangeableBand.create("0");
		ChangeableBand t3 = ChangeableBand.create("0");
		ChangeableBand t4 = ChangeableBand.create("0");
		ChangeableBand f1 = ChangeableBand.create("0");
		ChangeableBand f2 = ChangeableBand.create("0");
		TuringMaschinen
				.createSeq(isGreaterThanOrEqual(ChangeableBand.create("5"), ChangeableBand.create("3"), t1),
						TuringMaschinen.createSeq(
								isGreaterThanOrEqual(ChangeableBand.create("0"), ChangeableBand.create("0"), t2),
								TuringMaschinen.createSeq(
										isGreaterThanOrEqual(ChangeableBand.create("1"), ChangeableBand.create("0"),
												t3),
										TuringMaschinen.createSeq(
												isGreaterThanOrEqual(ChangeableBand.create("50"),
														ChangeableBand.create("50"), t4),
												TuringMaschinen.createSeq(
														isGreaterThanOrEqual(ChangeableBand.create("0"),
																ChangeableBand.create("1"), f1),
														isGreaterThanOrEqual(ChangeableBand.create("3"),
																ChangeableBand.create("4"), f2))))))
				.simuliere();
		assertEquals(Integer.valueOf(1), Integer.valueOf(t1.getBandInhalt()));
		assertEquals(Integer.valueOf(1), Integer.valueOf(t2.getBandInhalt()));
		assertEquals(Integer.valueOf(1), Integer.valueOf(t3.getBandInhalt()));
		assertEquals(Integer.valueOf(1), Integer.valueOf(t4.getBandInhalt()));
		assertEquals(Integer.valueOf(0), Integer.valueOf(f1.getBandInhalt()));
		assertEquals(Integer.valueOf(0), Integer.valueOf(f2.getBandInhalt()));
	}

	/**
	 * prüft, ob a größer als b ist. Schreibt in r eine 1, wenn dem so ist, sonst
	 * eine 0.
	 */
	public TuringMaschineMitBand isGreaterThan(ChangeableBand a, ChangeableBand b, ChangeableBand r) {
		ChangeableBand parkplatz = ChangeableBand.create("0");
		return TuringMaschinen.createSeq(TuringMaschinen.createSub(a, b, parkplatz), TuringMaschinen.createSeq(
				TuringMaschinen.createAdd(ChangeableBand.create("0"), ChangeableBand.create("0"), r),
				TuringMaschinen.createWhileNotEqual(parkplatz,
						TuringMaschinen.createSeq(
								TuringMaschinen.createAdd(ChangeableBand.create("0"), ChangeableBand.create("1"), r),
								TuringMaschinen.createAdd(ChangeableBand.create("0"), ChangeableBand.create("0"),
										parkplatz)))));
	}

	/**
	 * prüft, ob a größer oder gleich b ist. Schreibt in r eine 1, wenn dem so ist,
	 * sonst eine 0.
	 */
	public TuringMaschineMitBand isGreaterThanOrEqual(ChangeableBand a, ChangeableBand b, ChangeableBand r) {
		ChangeableBand ri = ChangeableBand.create("0");
		ChangeableBand rii = ChangeableBand.create("0");
		return TuringMaschinen
				.createSeq(isGreaterThan(a, b, r),
						TuringMaschinen
								.createSeq(TuringMaschinen.createAdd(r, ChangeableBand.create("0"), ri),
										TuringMaschinen.createWhileEqual(ri,
												TuringMaschinen.createSeq(isGreaterThan(b, a, rii),
														TuringMaschinen.createSeq(
																TuringMaschinen.createWhileEqual(rii,
																		TuringMaschinen.createSeq(
																				TuringMaschinen.createAdd(
																						ChangeableBand.create(
																								"1"),
																						ChangeableBand.create("0"), r),
																				TuringMaschinen.createAdd(
																						ChangeableBand.create("1"),
																						ChangeableBand.create("0"),
																						rii))),
																TuringMaschinen.createAdd(ChangeableBand.create("1"),
																		ChangeableBand.create("0"), ri))))));
	}
}
