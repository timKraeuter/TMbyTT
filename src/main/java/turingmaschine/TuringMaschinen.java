...
public class TuringMaschinen {
     ...
     * um 1 erhöht.
     *
     * @param band, wessen Wert bei Ausführung um 1 erhöht werden soll.
     ...
     * um 1 erhöht.
     *
     * @param ist0Band, wessen Wert bei Ausführung um 1 erhöht werden soll.
     * @return Increment-TuringMaschine
     */
    public static TuringMaschineMitBand createaPruefe0Maschine(final ChangeableBand ist0Band, final ChangeableBand ausgabeBand) {
     ...
     *
     * @param band, wessen Wert bei Ausführung um 1 verringert werden soll.
     ...
     *
     * @param bandWelchesAuf0GeprueftWird tm wird solang wiederholt ausgeführt,
     *                                    bis das bandWelchesAuf0GeprueftWird den Wert 0 hat.
     * @param tm                          wiederholt auszuführende Turingmaschine.
     * @return While-Turingmaschine.
     */
    public static TuringMaschineMitBand createWhile(final ChangeableBand bandWelchesAuf0GeprueftWird, final TuringMaschineMitBand tm) {
        final TuringMaschinenBuilder builder = TuringMaschine.builder();
        final Zustand stop = Zustand.create("stop");
        final TuringMaschineMitBand pruefe0Maschine = TuringMaschinen.createaPruefe0Maschine(bandWelchesAuf0GeprueftWird, ChangeableBand.create(""));
    ...
    private static Set<ElementDerUeberfuehrungsfunktion> ueberfuehrungVonWhileBerechnen(final TuringMaschineMitBand pruefe0Maschine, final TuringMaschineMitBand tm, final Zustand endZustandWhile) {
        final Set<ElementDerUeberfuehrungsfunktion> ueberfuehrungsfunktion = new HashSet<>();

        ueberfuehrungsfunktion.addAll(TuringMaschinen.neueUeberfuehrungenBerechnen(pruefe0Maschine, tm, endZustandWhile));
    ...
    private static Set<ElementDerUeberfuehrungsfunktion> alteUeberfuehrungenErweitern(final TuringMaschineMitBand pruefe0Maschine, final TuringMaschineMitBand tm) {
        final Set<ElementDerUeberfuehrungsfunktion> alteUeberfuehrungenErweitertUmNeutral = new HashSet<>();

        alteUeberfuehrungenErweitertUmNeutral.addAll(pruefe0Maschine.getMaschine().getUeberfuehrungsfunktion().stream()
                .map(ueberfuehrung -> TuringMaschine.erstelleUeberfuhrungMitBeliebigenZeichen(ueberfuehrung, tm.getBaender().size(), false))
                .collect(Collectors.toSet()));

        alteUeberfuehrungenErweitertUmNeutral.addAll(tm.getMaschine().getUeberfuehrungsfunktion().stream()
                .map(ueberfuehrung -> TuringMaschine.erstelleUeberfuhrungMitBeliebigenZeichen(ueberfuehrung, pruefe0Maschine.getBaender().size(), true))
                .collect(Collectors.toSet()));

        return alteUeberfuehrungenErweitertUmNeutral;
    }

    private static Set<ElementDerUeberfuehrungsfunktion> neueUeberfuehrungenBerechnen(final TuringMaschineMitBand pruefe0Maschine, final TuringMaschineMitBand tm, final Zustand endZustandWhile) {
        ...
        neueUeberfuehrungen.add(TuringMaschine.erstelleUeberfuhrungMitBeliebigenZeichen(inTMMit1, tm.getBaender().size(), false));
        neueUeberfuehrungen.add(TuringMaschine.erstelleUeberfuhrungMitBeliebigenZeichen(inStopMit0, tm.getBaender().size(), false));
        ...
        neueUeberfuehrungen.addAll(nachPruefe0Neutral.stream()
                .map(ueberfuehrung -> TuringMaschine.erstelleUeberfuhrungMitBeliebigenZeichen(ueberfuehrung, tm.getBaender().size(), true))
                .collect(Collectors.toSet()));
