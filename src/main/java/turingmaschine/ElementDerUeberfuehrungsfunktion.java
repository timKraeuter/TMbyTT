...
public class ElementDerUeberfuehrungsfunktion {
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(vonZustand, that.vonZustand) &&
                Objects.equals(zuZustand, that.zuZustand) &&
                Objects.equals(eingabe, that.eingabe) &&
                Objects.equals(zuSchreibendesZeichen, that.zuSchreibendesZeichen) &&
                lesekopfBewegung == that.lesekopfBewegung;
    }

    @Override
    public int hashCode() {
        return Objects.hash(vonZustand, zuZustand, eingabe, zuSchreibendesZeichen, lesekopfBewegung);
    }
}
